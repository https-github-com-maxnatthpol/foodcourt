		...
		margin-left: 410px;
					...
					<div class="wrap-input100 validate-input" data-validate="กรุณากรอก Password">
						...
						<div class="show-password">
								<span id="a_pass" onclick="showPass()"><i class="fa fa-eye-slash"></i></span>
							</div>
					</div>
...
function showPass() {
  ...
  if (x.type === "password") {
    x.type = "text";
	document.getElementById("a_pass").innerHTML = "<i class='fa fa-eye'></i>";  
  } else {
    x.type = "password";
	document.getElementById("a_pass").innerHTML = "<i class='fa fa-eye-slash'></i>";  
  }
}
</script>