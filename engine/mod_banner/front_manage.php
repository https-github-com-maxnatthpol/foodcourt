  ...
  <div class="<?php echo $col ?>">   
         <div class="card card-body" >
          <div class="box-header with-border">
            <h3 class="box-title">รายการสไลด์แบนเนอร์</h3>
          </div>
...
<div id="div_add" class="col-md-6" style="<?php echo $button_create ?>">
        <div class="card card-body" >
          <div class="box-header with-border">
            <h3 class="box-title">เพิ่มสไลด์แบนเนอร์</h3>
              ...
              <div id="div_form_add">
                  <div class="card">
                                ...
                                <div class="tab-pane active" id="thai" role="tabpanel">
                                    <div class="card-body">
                                      ...
                                      <div class="form-group" id="editor" style="margin-top: 10px;">
                                        ...
                                        <textarea id='edit' class='edit' name="text" style="margin-top: 20px;"></textarea>
                                      </div>
                                ...
                                <div class="tab-pane" id="english" role="tabpanel">
                                    <div class="card-body">
                                      ...
                                      <div class="form-group" id="editor" style="margin-top: 10px;">
                                        ...
                                        <textarea id='edit' class='edit' name="text_en" style="margin-top: 20px;"></textarea>
                                      </div>
                        ...
                        <div class="form-group">
                          <div class="card">
                            <div class="card-body ">
                              <label for="input-file-now">รูปภาพ</label> <span class="text-danger">( ขนาด 1920 * 1080 pixel )</span>
