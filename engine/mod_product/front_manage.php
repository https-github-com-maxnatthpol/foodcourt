         ...
         <div class="card card-body" >
            ...
            <div class="row"> 
            	<div class="col-md-6" align="left">
					...
					<?php
						if ($button_create=='') {
					?>
                		<a href="front_courese_manage.php"  style="transition: 0.4s;<?php echo $button_create ?>"  class="btn btn-success pull-right"    ><i class="mdi mdi-plus"></i> เพิ่มสินค้าใหม่</a> 
					<?php
						  }
					?>
					</div>
          ...
          <div class="box-body" style="padding: 0;">
            <form action="" name="frmMain" id="frmMain" method="post">
              <input type="hidden" name="form" value="Multi_del_course">
