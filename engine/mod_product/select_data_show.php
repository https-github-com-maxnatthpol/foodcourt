                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-11 col-md-9">
                                        <div id="slimtest1" class="slimtest1">
                                            <button style="display: none;" type="button" class="close pull-right" data-dismiss="alert" aria-label="Close"> 
    ...
    $messages_en_head = htmlspecialchars_decode($objResult["messages_en"]); ?>
                    <div class="row">
                      <div class="form-group col-md-9 ">
                        ...
                        <div class="row"> 
                          <div class="form-group col-md-7">
                            <input disabled type="checkbox" name="question_random_flg" id="question_random_flg_edit" value="1" class=" filled-in chk-col-light-blue" <?php echo $random_flg ?> /><label for="question_random_flg_edit">สุ่มคำตอบ</label>
                            <input disabled class="form-control col-md-4" type="number" name="random_number" id="random_number_edit" min="0" OnKeyPress="return check_num(this)" value="<?php echo $objResult["random_number"] ?>"> <label for="random_number_edit"> ตัวเลือก </label>
                          </div>

                          <div class="form-group col-md-5">
                            <input disabled type="checkbox" <?php echo $skip_test_flg ?> name="skip_test_flg" id="skip_test_flg_edit" value="1" class=" filled-in chk-col-light-blue" /><label for="skip_test_flg_edit">อนุญาตให้ข้ามคำถาม</label>
                          </div>
                        </div>
                      ...
                      <div class="form-group col-md-3">
                        ...
                        <input disabled class="form-control" type="number" name="time_limit" id="time_limit_edit" min="0" OnKeyPress="return check_num(this)" value="<?php echo $objResult["time_limit"] ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="row"> 
                        <div class="form-group col-md-8">
                          <select disabled class="form-control " name="type_answer" id="type_answer_edit">
  ...
  if ($objResult["name"] !='') {
      ...
      echo "<a onclick='edit_pic(" .'"div_img_quiz_question_edit"'."," .'"'.$directory.'"'.")'><img class='img-responsive radius num_img' src='".$directory."' width='150px'></a> <input type='hidden' name='directory_question' value='".$result_answer["directory"]."'><input type='hidden' name='newname_img_question' value='".$result_answer["name"]."'><input type='hidden' name='tmp_size_question' value='".$result_answer["tmp_size"]."'>";
                                      ...
                                      <div class="input-group">
                                          ...
                                          <input disabled onkeyup ="disabled_btn_add_question()" type="text" class="form-control quiz_question_name_edit" id="quiz_name_th_question" name="quiz_name_th_question" placeholder="ภาษาไทย" value="<?php echo  strip_tags($messages_th_head)  ?>">
                                          <input disabled type="hidden" class="form-control" id="question_name_th_editor_edit" name="quiz_question_name_th_taxteditor" placeholder="quiz_name_th_taxteditor" value="<?php echo $objResult["messages_th"] ?>">
                                          <div class="input-group-prepend">
                                      ...
                                      <div class="input-group">
                                        ...
                                        <input disabled type="text" class="form-control quiz_question_name_edit" id="quiz_question_name_en" name="quiz_question_name_en" placeholder="ภาษาอังกฤษ" value="<?php echo strip_tags($messages_en_head) ?>">
                                        <input disabled type="hidden" class="form-control" id="question_name_en_editor_edit" name="quiz_question_name_en_taxteditor" placeholder="ภาษาอังกฤษ" value="<?php echo $objResult["messages_en"] ?>">
                                        <div class="input-group-prepend">
                                               <button disabled onclick="open_modal_pic('div_img_quiz_question_edit')" data-toggle="modal" data-target="#modal_add_quiz_question_pic" type="button" class="btn btn-default pull-righ open_pic_question" style="transition: 0.4s; " id=""  ><i class="mdi mdi-image"> </i> </button>
                                          </div>
                                      </div>
                                      </div>
...
WHERE course_answer.id_question = '".$_POST['id_question']."'  AND course_answer.`delete_datetime` IS null ORDER BY course_answer.order ASC";
   ...
   <div class="form-group removeclass_<?php echo $i ?>" id="div_answer_<?php echo $i ?>">
                      <label for="example-email">คำตอบ<?php //echo $result_answer["correct_flg"]?></label>
                       <input disabled type="hidden" name="id_answer[]"  value="<?php echo $result_answer["id_answer"] ?>">
                      <div class="input-group">
                        <div class="input-group-prepend">
                            <button class="btn btn-default pull-righ " style="transition: 0.4s; ">
                              <img class="flag-lang" src="img/th-fl.png" width="22" height="15" > 
                        ...
                        <input disabled onfocus="open_editor_answer('<?php echo $i ?>')" class="form-control" type="text" name="answer[]" id="answer_<?php echo $i ?>" value="<?php echo strip_tags($messages_th) ?>">
                        <input disabled type="hidden" name="editor_answer[]" id="editor_answer_<?php echo $i ?>" value="<?php echo $result_answer["messages_th"] ?>">
                        <div class="input-group-prepend">
                          <button disabled onclick="remove_education_fields('_<?php echo $i ?>');"  type="button" class="btn btn-default pull-right " style="transition: 0.4s; " id=""  > <i class="mdi mdi-delete"> </i> </button>
                      ...
                      <div class="input-group">
                        ...
                        <input disabled onfocus="open_editor_answer('<?php echo $i ?>')" class="form-control" type="text" name="answer_en[]" id="answer_en_<?php echo $i ?>" value="<?php echo strip_tags($messages_en) ?>">
                        <input disabled type="hidden" name="editor_answer_en[]" id="editor_answer_en_<?php echo $i ?>" value="<?php echo $result_answer["messages_en"] ?>">
                        <div class="input-group-prepend">
                          ...
                          <button disabled onclick="open_modal_pic('div_img_quiz_question_<?php echo $i ?>')" data-toggle="modal" data-target="#modal_add_quiz_question_pic" type="button" class="btn btn-default pull-righ open_pic_question" style="transition: 0.4s; " id=""  ><i class="mdi mdi-image"> </i> </button>
                        </div>
...
<?php
  if ($result_answer["name"] !='') {
      ...
      echo "<a onclick='edit_pic(" .'"div_img_quiz_question_'.$i.'"'."," .'"'.$directory.'"'.")'><img class='img-responsive radius num_img' src='".$directory."' width='150px'></a> <input type='hidden' name='directory[]' value='".$result_answer["directory"]."'><input type='hidden' name='newname_img[]' value='".$result_answer["name"]."'><input type='hidden' name='tmp_size[]' value='".$result_answer["tmp_size"]."'><input type='hidden' name='id_image[]'  value='".$result_answer["id_image"]."'>";
                      ...
                      <input disabled <?php echo $correct_flg ?> type="checkbox" onchange="checkbox_val(<?php echo $i ?>)"  name="correct_flg[<?php echo $i ?>]" id="correct_flg_edit_<?php echo $i ?>" value="" class=" filled-in chk-col-light-blue " /><label for="correct_flg_edit_<?php echo $i ?>">คำตอบที่ถูกต้อง</label>
                      <input disabled type="hidden" name="correct_flg_val[]" id="correct_flg_val_<?php echo $i ?>" value="<?php echo $result_answer["correct_flg"] ?>">
                    </div>
<?php $i++;
    } ?>
    ...
    while ($objResult = mysqli_fetch_array($objQuery, MYSQLI_ASSOC)) {
        $num++; ?>
          ...
          <?php echo  $objResult['order'] ?>
				...
				<td>
					<a  style="color: #FFFCFC;<?php echo $button_view ?>"  class="btn btn-info  btn-sm edit_btn_class_schedule" data-id="<?php echo $objResult['id_lesson'] ?>" data1-id="<?php echo $objResult['name_th'] ?>" data2-id="<?php echo $objResult['name_en'] ?>"  ><i class="mdi mdi-eye-outline"></i></a>

          <a  style="color: #FFFCFC;  <?php echo $button_view ?>"  class="btn btn-info  btn-sm lesson_content_btn" data-id="<?php echo $objResult['id_lesson'] ?>"  data1-id="<?php echo $objResult["name_th"] ?>" >เนื้อหา</a>
...
function div_table_list_content()
{
    ...
    $strSQL = "SELECT course_subject.`id_subject`,course_subject.`name_th`,course_subject.`name_en`,course_subject.`order` ,course_images.file_type,course_subject.link_video,course_subject.link_reference,course_images.name,course_images.directory,course_images.id_image
  FROM `course_subject` 
  ...
  $num=0;
    while ($objResult = mysqli_fetch_array($objQuery, MYSQLI_ASSOC)) {
      ...
      <tr class="show-tr_content">
        ...
        <td>
          <a  style="color: #FFFCFC;<?php echo $button_view ?>"  class="btn btn-info  btn-sm edit_btn_content" data-id="<?php echo $objResult['id_subject'] ?>" data1-id="<?php echo $objResult['name_th'] ?>" data2-id="<?php echo $objResult['name_en'] ?>" data3-id="<?php echo $objResult['link_video'] ?>" data4-id="<?php echo $objResult['link_reference'] ?>" data5-id="<?php echo $objResult['name'] ?>" data6-id="<?php echo $objResult['directory'] ?>" data7-id="<?php echo $objResult['id_image'] ?>"   ><i class="mdi mdi-eye-outline"></i></a>
  ...
  $num=0;
    while ($objResult = mysqli_fetch_array($objQuery, MYSQLI_ASSOC)) {
      ...
      <tr class="show-tr_quiz">
        ...
        <td>
          <a  style="color: #FFFCFC;<?php echo $button_view ?>"  class="btn btn-info  btn-sm edit_btn_quiz" data-id="<?php echo $objResult['id_quiz'] ?>" data1-id="<?php echo $objResult['name_th'] ?>" data2-id="<?php echo $objResult['name_en'] ?>" data3-id="<?php echo $objResult['pass_new_flg'] ?>" data4-id="<?php echo $objResult['pass_new_number'] ?>" data5-id="<?php echo $objResult['fail_new_flg'] ?>"  data6-id="<?php echo $objResult['fail_new_number'] ?>" data7-id="<?php echo $objResult['random_flg'] ?>" data8-id="<?php echo $objResult['exam_number'] ?>"   ><i class="mdi mdi-eye-outline"></i></a>

          <a  style="color: #FFFCFC;  <?php echo $button_view ?>"  class="btn btn-info  btn-sm course_question_btn" data-id="<?php echo $objResult['id_quiz'] ?>"  data1-id="<?php echo $objResult["name_th"] ?>" >คำถาม</a>
  ...
  $num=0;
    while ($objResult = mysqli_fetch_array($objQuery, MYSQLI_ASSOC)) {
      ...
      <tr class="show-tr_question">
        ...
        <td>
          <a  style="color: #ffffff; <?php echo $button_view ?>"  class="btn btn-info  btn-sm edit_btn_content_question" data-id="<?php echo $objResult['id_question'] ?>"   ><i class="mdi mdi-eye-outline"></i></a>
...
<?php
  ...
  function div_table_list_course()
  {
      ...
      $strSQL = "SELECT partner.name_th AS name_pertner, category.name_th AS name_category, CONCAT(tutor.forename_th,' ',tutor.surename_th) AS name_tutor, course.id_course,course.name_th, course.age,course.age_unit, course.price
FROM `course` 
LEFT JOIN partner ON course.id_partner=partner.id_partner
LEFT JOIN category ON category.id_category=course.id_category
LEFT JOIN tutor ON tutor.id_tutor=course.id_tutor
WHERE course.delete_datetime IS null ";
      $objQuery = $db->Query($strSQL); ?>
<H3></H3>
  <table class="table" id="table_list_course" width="100%" >
    <thead >
      <th >
...
<?php
  $num=0;
      ...
      <tr class="show-tr_question">
        <td>
          <input type="checkbox" name="Chk_question[]" id="Chk_course<?php echo $num ?>" value="<?php echo $objResult['id_course'] ?>" class="checkbox_remove_course filled-in chk-col-light-blue" /><label for="Chk_course<?php echo $num ?>"></label>
        </td>
        <td>
          <?php echo $objResult["name_th"] ?>
        </td>
        <td>
          <?php echo $objResult["name_tutor"] ?>
        </td>
        <td>
          <?php echo $objResult["name_category"] ?>
        </td>
        <td>
          <?php echo $objResult["name_pertner"] ?>
        </td>
        <td>
        ...
        <td>
          <?php
            if ($objResult["age_unit"] == '1') {
                echo $objResult["age"].'ชั่วโมง' ;
            } elseif ($objResult["age_unit"] == '2') {
                echo $objResult["age"].'วัน' ;
            } elseif ($objResult["age_unit"] == '3') {
                echo $objResult["age"].'สัปดาห์' ;
            } elseif ($objResult["age_unit"] == '4') {
                echo $objResult["age"].'เดือน' ;
            } ?>
        </td>
        <td>
