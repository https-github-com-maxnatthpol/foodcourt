...
<div id="div_add" class="col-md-6" style="<?php echo $button_view ?>">
        <div class="card card-body" >
          <div class="box-header with-border">
            <h3 class="box-title">รายการ บริการของเรา</h3>
          </div>
...
<div id="div_add" class="col-md-6" style="<?php echo $button_create ?>">
        <div class="card card-body" >
          <div class="box-header with-border">
            <h3 class="box-title">เพิ่ม บริการของเรา</h3>
          ...
          <div class="box-body" style="padding: 0;">
            <form action="" name="form_add" id="form_add" method="post">
                                ...
                                <div class="tab-pane active" id="thai" role="tabpanel">
                                    <div class="card-body">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input onkeyup ="disabled_btn_add_fuature()" type="text" class="form-control" id="name_th" name="name_th" placeholder="ภาษาไทย">
                                      </div>
                    ...
                    <div class="">
                      <div class="card">
                        <div class="card-body ">
                          ...
                          <input accept="image/*" type="file" id="fuature_img" class="dropify" name="fuature_img" onchange="chk_pic()"/>
                        </div>
                      </div>
                    </div>
              ...
              <div class="boxsave" id="box-del-list" align="center">
				...
				<button disabled  type="button" class="btn btn-success  btnSendAdd" id="btnSendAdd" style="transition: 0.4s; margin-left: 5px;" ><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;เพิ่ม บริการของเรา ใหม่</button> 
...
function chk_pic(){
  var file=document.form_add.fuature_img.value;
...
function chk_pic_edit(){
  var file=document.form_edit.fuature_img.value;
  var patt=/(.jpg|.png|.jpeg)/;
  var result=patt.test(file);
        if(!result){
          swal.fire("คำเตือน", 'ประเภทไฟล์ไม่ถูกต้อง ("jpeg", "jpg", "png" only)', "error");
