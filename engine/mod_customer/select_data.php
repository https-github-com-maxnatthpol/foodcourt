...
function select_div_edit_front_manage()
{
  ...
  $strSQL = "SELECT  user_images.name AS name_img, user_images.directory, mod_customer.forename, mod_customer.id_card, mod_customer.id_catagory, mod_customer.email,mod_customer.telephone,mod_customer.level
    FROM `mod_customer` 
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <select class="form-control select2" name="id_category_edit" id="id_category_edit">
                  ...
                  ?>
                    <option value="<?php echo $objResult_cate["id_catagory"] ?>" <?php if ($objResult["id_catagory"] == $objResult_cate["id_catagory"]) {
                                                                                    echo "selected";
                                                                                  } ?>>
                      <?php
              ...
              <div class="form-group">
                <label for="example-email" class="text-themecolor"><i class="fas fa-list-alt"></i> ระดับร้านค้า </label>
                <select class="form-control select2" name="level_edit" id="level_edit">
                  <?php 
                  if($objResult["level"] == 0){
                    echo '<option value="0" selected>ระดับ 0</option>';
                    echo '<option value="1">ระดับ 1</option>';
                  }
                  if($objResult["level"] == 1){
                    echo '<option value="0">ระดับ 0</option>';
                    echo '<option value="1" selected>ระดับ 1</option>';
                  }
                  ?>
                </select>
              </div>
