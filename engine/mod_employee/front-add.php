  ...
  ?>
	<div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">เพิ่มพนักงาน</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:location.href='../index.php'">Home</a></li>
                            <li class="breadcrumb-item"><a href="javascript:location.href='front-manage.php'">รายชื่อพนักงาน</a></li>
      ...
      <div class="alert alert-success alert-dismissible" id="result_add" style="display: none;">
            ...
            <div id="success_add">
              <h4><i class="icon fa fa-check"></i> เพิ่มข้อมูล!</h4>
              เพิ่มข้อมูลสำเร็จ.
            </div>
          </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <center><h4>เพิ่มพนักงานเรียบร้อยแล้ว คุณจะไปหน้าจัดการพนักงานหรือไม่</h4></center>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-default pull-left" data-dismiss="modal">เพิ่มพนักงานต่อ..</button>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="card">
                            <div class="card-body card-body-img">
                                ...
                                <input type="file" name="image_employee" accept="image/*" id="imgInp" class="dropify checkfileemployee" data-default-file="" />
                                </div>
                        </div>
                                <div class="card">
                                <div class="card-body">
								...
								<p>เลขที่บัตรประชาชน : <font id="code-ex"></font><br></p>
                        ...
                        <div class="col-md-6">
						  <div class="p-10">
                              ...
                              <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="ชื่อพนักงาน" name="employee-name" id="employee-name" oninput="myFunctionex()">
                         		</div>
                     		</div>	
                        </div>
                        <div class="col-md-6">
						  <div class="p-10">
                              ...
                              <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="นามสกุล" name="employee-sur" id="employee-sur" oninput="myFunctions_ex()">
                         		</div>
                     		</div>	
                        </div>
                        <div class="col-md-6">
						  <div class="p-10">
                              ...
                              <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" maxlength="13" onkeypress="return isNumber(event)" placeholder="รหัสประจำตัวประชาชน" name="employee-code" id="employee-code" oninput="myFunctionc_ex()">
                         		</div>
                     		</div>	
                        </div>
                        <div class="col-md-6">
						  <div class="p-10">
                              ...
                              <div class="input-group">
                                    ...
                                    <input type="text" class="form-control pull-right" id="datepicker-autoclose" name="employee-date"  placeholder="วัน/เดือน/ปี">
                         		</div>
                     		</div>
						  </div>
                        <div class="col-md-6">
						  <div class="p-10">
                              ...
                              <div class="input-group">
                                    ...
                                    <input type="text" class="form-control pull-right" placeholder="ตำแหน่งพนักงาน" id="employee-opti" name="employee-opti" oninput="myFunctionp_ex()">
                         		</div>
                     		</div>	
                        </div>
                        <div class="col-md-6">
						  <div class="p-10">
                              ...
                              <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" maxlength="10" id="tel" name="tel" onkeypress="return isNumber(event)" placeholder="เบอร์โทรศัพท์">
                         		</div>
                     		</div>	
                        </div>
                        <div class="col-md-6">
						  <div class="p-10">
                              ...
                              <div class="input-group">
                                    ...
                                    <textarea type="text" class="form-control" id="employee-detail" placeholder="รายละเอียดพนักงาน" name="employee-detail"></textarea>	
                         		</div>
                     		</div>	
                        </div>
                      </div> 
                        ...
                        <div class="col-md-6">
						  <div class="p-10">
                              ...
                              <div class="input-group">
                                    ...
                                    <textarea class="form-control" placeholder="รายละเอียดพนักงาน" id="employee-detail-en" name="employee-detail-en"></textarea>
                         		</div>
                     		</div>	
                        </div>
                      </div> 
                  ...
                  <div class="card-card-center">
                    ...
                    <div class="p-10">
                      <p>ชื่อผู้ใช้งาน  <font class="warning-text-check-b2" id="employee-user-text">*</font>
                                        ...
                                        <i class="fa fa-times-circle wrong-check" id="user_text_no" style="position:absolute; margin-left: 10px; color: red !important; display: none;"> ชื่อผู้ใช้มีอยู่แล้ว.</i></p>
					  <div class="input-group">
                                	<div class="input-group-prepend">
                                      	<span class="input-group-text">
...
if ($_SESSION['admin']  != '0') {
    $str_perm = "SELECT `system`.`id_system`,`system`.`link_system` , 0 as permissions
  FROM `system` ";
} else {
  ...
  AND `roles`.`id_role` = role_permissions.id_role AND  `roles`.tag = 'mod_employee' ";
}
...
$status_admin  = $_SESSION['admin'];
      ...
      echo $output; ?>
			  ...
			  <div class="box-footer" style="border: none;">
                ...
                <button type="button" class="btn btn-success pull-right" id="next-login" disabled style="transition: 0.4s; margin-left: 5px; float: right;"></i>&nbsp;ถัดไป</button>
                <button type="button" class="btn btn-success pull-right" id="next-view" style="transition: 0.4s; margin-left: 5px; display: none; float: right;"></i>&nbsp;ถัดไป</button>
                    ...
                    <div class="col-12 m-t-30">
                        <div class="card">
                            <div class="card-body collapse show" style="border-top: solid #1e88e5;">
								<button type="button" class="btn btn-info btnSendAdd" id="btnSendAdd" style="transition: 0.4s; margin-left: 5px; float:right;" disabled><i class="fa fa-check"></i>&nbsp;บันทึก</button>
          						<button type="button" class="btn btn-warning btnSendClear" id="btnSendClear" style="float:right"><i class="fa fa-times"></i>&nbsp;เคลียร์</button>
                            </div>
                        </div>
                    </div>
                <!-- End Row -->
     ...
     //------------------------------------------------------------ADD article--------------------------------------------------------------
        $(document).on('click', '.btnSendAdd', function(){ 
            if($('#next-view').is(':disabled',true) || $('#next-login').is(':disabled',true)){
              ...
              if($('#user_text_no').css('display') === 'block'){
              swal.fire("คำเตือน", "ชื่อผู้ใช้งานนี้มีการใช้งานแล้ว  กรุณาเปลี่ยนใหม่", "warning");
              return false
            }
