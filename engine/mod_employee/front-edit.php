...
$variables = "s";
$data = [$_GET['id']];
$result = $db->selectFetch($sql, $variables, $data);
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">แก้ไขพนักงาน</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="card">
                            <div class="card-body card-body-img">
								...
								<p>เลขที่บัตรประชาชน : <font id="code-ex"><?php echo $result['code_id']; ?></font><br></p>
