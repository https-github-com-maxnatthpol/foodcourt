      ...
      ?>
        <tr class="show-tr">
          ...
          <td>
            ...
            <button type="button" data-toggle="modal" data-target="#modal_print" style="<?php echo $button_update ?>" class="btn btn-info btn-sm print_btn" data-id="<?php echo $objResult['id_cashier'] ?>" data1-id="<?php echo $objResult["forename"]; ?>"><i class="fas fa-print"></i> การปริ้น</button>
          </td>
        </tr>
      <?php
...
function select_div_print(){
  ...
  $strSQL = "SELECT `id_cashier`,`ip_cashier`,`print_cashier` FROM `mod_cashier` WHERE `id_cashier`= '".$_POST["id"]."' ";
  $objQuery = $db->Query($strSQL);
  $objResult = mysqli_fetch_array($objQuery, MYSQLI_ASSOC);
...
<div class="card card-body" >
          ...
          <div class="box-body" style="padding: 0;">
            <form action="" name="form_print" id="form_print" method="post">
              ...
              <input type="hidden" name="id_edit" value="<?php echo $_POST["id"] ?>">
              <input type="hidden" name="id_print" value="<?php echo $objResult["id_cashier"] ?>">
              <div id="div_form_edit">
                ...
                <div class="row"> 
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control iconified" name="ip_cashier" id="ip_cashier" placeholder="192.168.xx.xxx" value="<?php echo $objResult["ip_cashier"] ?>">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6" >    
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control iconified" name="print_cashier" id="print_cashier" placeholder="ชื่อเครื่องปริ้นของคุณ" value="<?php echo $objResult["print_cashier"] ?>">
                        </div>
                      </div>
                </div>
