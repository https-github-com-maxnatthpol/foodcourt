...
(function ($) {
    if($.fn.ajaxForm == undefined) {
        $.getScript("Assets/plugins/upfile/js/jquery.form.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
	   ...
	   this.startUpload = function () {
		...
		function defaultProgressBar(obj,s)
		{
            ...
            this.textname = $("<input type='hidden' name='file_name[]' id='file_name' value=''/>").appendTo(this.statusbar);
            this.filename = $("<div class='ajax-file-upload-filename' id='nunu'></div>").appendTo(this.statusbar);
